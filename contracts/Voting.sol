...
contract Voting {
  ...
  function Voting(bytes32[] memory _candidateNames, bytes32[] memory _candidateHashes) public {
  ...
  //function voteForCandidate(bytes32 _candidate, address _voter) public {
